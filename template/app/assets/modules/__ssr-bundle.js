(() => {
  ...
  // app/assets/modules/404-7e8d33bb.js
  var e8d33bb_exports = {};
  __export(e8d33bb_exports, {
    default: () => _404
  });
  var _404;
  var init_e8d33bb = __esm({
    "app/assets/modules/404-7e8d33bb.js"() {
      _404 = new window.nijor.component(async function() {
        return `<div n-scope="VWBNXwhabrYenvF4gJzg">
        <h1 n-scope="VWBNXwhabrYenvF4gJzg">404 Not found!</h1>
        <p n-scope="VWBNXwhabrYenvF4gJzg">It seems as if the page you are looking for is under construction or not found. <br n-scope="VWBNXwhabrYenvF4gJzg">
        Please go to the <a n-scope="VWBNXwhabrYenvF4gJzg" onclick="return window.nijor.redirect(this.href)" href="/">Home</a> page.
        </p>
    </div>
`;
      }, async function() {
  ...
  // app/assets/modules/index-41173348.js
  var index_41173348_exports = {};
  __export(index_41173348_exports, {
    default: () => index
  });
  var index;
  var init_index_41173348 = __esm({
    "app/assets/modules/index-41173348.js"() {
      init_app();
      index = new window.nijor.component(async function() {
...
`;
  ...
  // app/assets/modules/welcome-e6570721.js
  var welcome_e6570721_exports = {};
  __export(welcome_e6570721_exports, {
    default: () => welcome
  });
  var welcome;
  var init_welcome_e6570721 = __esm({
    "app/assets/modules/welcome-e6570721.js"() {
      init_app();
      welcome = new window.nijor.component(async function() {
        return `<div class="main" n-scope="FZYoYVEM5dtgT2sq4xiE">
        <img src="${img}" n-scope="FZYoYVEM5dtgT2sq4xiE">
        <span class="welcome-msg" n-scope="FZYoYVEM5dtgT2sq4xiE"> Welcome to the world of Nijor !</span>
        <p n-scope="FZYoYVEM5dtgT2sq4xiE">Edit the src/ folder to reflect changes in this website !</p>
    </div>
`;
      }, async function() {
      });
  ...
  async function RenderRoutes(route) {
    ...
    if (window.nijor.routes.has(route))
      return await window.nijor.routes.get(route)();
    return await RenderRouteWithVars(route, window.nijor.routes);
  }
  async function RenderSlots(route) {
    if (route.endsWith("/") && route != "/")
      route = route.substring(0, route.length - 1);
    if (window.nijor.slots.has(route))
      return await window.nijor.slots.get(route)();
  }
  ...
  var component, Handler, reactiveVars, img, $header, $footer, App;
  var init_app = __esm({
    "app/assets/modules/app.js"() {
      component = class {
        ...
        run = async function(urlParameters) {
          ...
          if (document.getElementsByTagName(this.name).length === 0)
            return;
          let allSpecs = getAttributes(element);
          if (urlParameters != null)
            allSpecs = urlParameters;
          try {
            element.innerHTML = "";
          } catch (error) {
          }
      ...
      reactiveVars = new Proxy({}, Handler);
      ...
      window.nijor.routes = /* @__PURE__ */ new Map();
      window.nijor.routes.set("/", () => {
      });
      window.nijor.slots = /* @__PURE__ */ new Map();
...
`;
      ...
      $footer = new window.nijor.component(async function() {
...
`;
      ...
      App = new window.nijor.component(async function() {
    ...
    <footerdei2 n-scope="0ObqPiYEZJKFi0H98"></footerdei2>
      ...
      window.nijor.setRoute("/404", () => Promise.resolve().then(() => (init_e8d33bb(), e8d33bb_exports)), "/");
      window.nijor.setRoute("/", () => Promise.resolve().then(() => (init_index_41173348(), index_41173348_exports)), "/");
      window.nijor.setRoute("/welcome", () => Promise.resolve().then(() => (init_welcome_e6570721(), welcome_e6570721_exports)), "/");
      App.init("app");
      App.run();
