...
var $header = new window.nijor.component(async function(){
                  ...
                  return(`<div class="container" n-scope="poAloO3dF8">
        <a n-scope="poAloO3dF8" onclick="return window.nijor.redirect('/')" href="/"><img src="${img}" n-scope="poAloO3dF8"></a>
        <div class="nav-bar" n-scope="poAloO3dF8">
            <a href="https://github.com/nijor" class="nav-link" n-scope="poAloO3dF8">Docs</a>
        </div>
    </div>
`);
              },async function(){
...
var $footer = new window.nijor.component(async function(){
                  ...
                  return(`<div n-scope="Lrvi1ciYgdCklo3Tn">
        <p n-scope="Lrvi1ciYgdCklo3Tn">Nijor Template Website</p>
    </div>
`);
              },async function(){
...
var App = new window.nijor.component(async function(){
                  ...
                  return(`<headeryo n-scope="gM9uLD3XtTL8hTIaz0"></headeryo>
        <div id="n-routes" n-scope="gM9uLD3XtTL8hTIaz0"></div>
    <footeryo n-scope="gM9uLD3XtTL8hTIaz0"></footeryo>
`);
              },async function(){
                
                
              $header.init('headeryo');
              await $header.run();
            
              $footer.init('footeryo');
              await $footer.run();
...
var Index = new window.nijor.component(async function(){
                  ...
                  return(`<div class="main" n-scope="R6hVpV">
        <img src="${img}" n-scope="R6hVpV">
        <p n-scope="R6hVpV">
            <span style="font-size: 35px; font-weight: bold;" n-scope="R6hVpV">Nijor</span>
            <span class="tagline" n-scope="R6hVpV"> : A modern and practical web framework !</span>
        </p>
        <a n-scope="R6hVpV" onclick="return window.nijor.redirect('/welcome')" href="/welcome"><button n-scope="R6hVpV">Get Started</button></a>
    </div>
`);
              },async function(){
...
var Welcome = new window.nijor.component(async function(){
                  ...
                  return(`<div class="main" n-scope="WcZwND7Nl7V54VOi">
        <img src="${img}" n-scope="WcZwND7Nl7V54VOi">
        <span class="welcome-msg" n-scope="WcZwND7Nl7V54VOi"> Welcome to the world of Nijor !</span>
        <p n-scope="WcZwND7Nl7V54VOi">Edit the src/ folder to reflect changes in this website !</p>
    </div>
`);
              },async function(){
...
var Error404 = new window.nijor.component(async function(){
                  ...
                  return(`<div n-scope="jry8Syh0">
        <h1 n-scope="jry8Syh0">404 Not found!</h1>
        <p n-scope="jry8Syh0">It seems as if the page you are looking for is under construction or not found. <br n-scope="jry8Syh0">
        Please go to the <a n-scope="jry8Syh0" onclick="return window.nijor.redirect('/')" href="/">Home</a> page.
        </p>
    </div>
`);
              },async function(){
